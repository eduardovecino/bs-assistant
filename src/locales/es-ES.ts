...
export const SPANISH_TRANSLATIONS = {
    ...
    'intent.information.contact.simple_response': `Puedes contactarnos, cualquier día y a cualquier hora, a través del teléfono: ${Ssml.sayAs({ text: "902 323 000", interpret: As.telephone })} `,
}
