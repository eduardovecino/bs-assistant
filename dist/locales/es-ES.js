...
exports.SPANISH_TRANSLATIONS = {
    ...
    'intent.information.contact.simple_response': `Puedes contactarnos, cualquier día y a cualquier hora, a través del teléfono: ${ssml_gib_1.Ssml.prosody(ssml_gib_1.Ssml.sayAs({ text: "902 323 000", interpret: ssml_gib_1.As.characters }), { rate: "slow" })} `,
};
